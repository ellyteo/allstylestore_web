  ...
  return (
    <footer className="footer">
      ...
      <div className="footer__body">
        {/* Redes sociais – usando icons.svg ou SVGs inline como fallback */}
        ...
        <div className="footer__columns">
          <div className="footer__col">
            ...
            <p>Inscreva-se para ter acesso exclusivo a venda antecipada, novidades e promoções.</p>
          </div>
          ...
          <div className="footer__col">
            <h4>Fale conosco</h4>
            <ul>
              <li>Tel: (47) 99999-9999</li>
              <li>E-mail: allstylestore@gmail.com</li>
            </ul>
          </div>
        </div>

        <div className="footer__bottom">
          <span>WWW.ALLSTYLESTORE.COM</span>
        </div>
      </div>
